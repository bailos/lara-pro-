				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">Souhaits</a></li>
						</ul>
					</div>
				</div>
			</div>
							...
							@else 
								<tr>
									<td class="text-center">
										Il y'a pas de liste de souhait disponible. <a href="{{route('product-grids')}}" style="color:blue;">Continuer les achats</a>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service">
						<i class="ti-rocket"></i>
						<h4>Expedition gratuite</h4>
						<p>Commande de plus de 100 000</p>
					</div>
					<!-- End Single Service -->
				</div>
				<div class="col-lg-3 col-md-6 col-12">
