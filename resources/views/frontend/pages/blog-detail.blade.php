                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>via {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Comment ({{$post->allComments->count()}})</a></span>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Poster un commentaire</span><span class="comment_btn reply" style="display: none;">Repondre à un commentaire</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                               Tu as besoin de <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">te connecter</a> OU <a style="color:blue" href="{{route('register.form')}}">t'rnregister</a> pour commenter.
                    ...
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Souscrire & obtenir des news <br>des dernieres mises à jour.</h4>
