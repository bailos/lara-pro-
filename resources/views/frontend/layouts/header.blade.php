            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                        <li><i class="ti-location-pin"></i> <a href="{{route('order.track')}}">Suivez vos tontines</a></li>
                            {{-- <li><i class="ti-alarm-clock"></i> <a href="#">Business du jour</a></li> --}}
                            @auth 
                    ...
                    <div class="search-bar-top">
                        <div class="search-bar">
                            ...
                            <form method="POST" action="{{route('product.search')}}">
                                @csrf
                                <input name="search" placeholder="Chercher un produit ici....." type="search">
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span>{{count(Helper::getAllProductFromWishlist())}} Produits</span>
                            ...
                            @auth
                                <div class="shopping-item">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="{{route('checkout')}}" class="btn animate">Caisse</a>
                                    </div>
                                </div>
                            @endauth
                            <!--/ End Shopping Item -->
