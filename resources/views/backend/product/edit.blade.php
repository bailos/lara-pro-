...
<div class="card">
    <h5 class="card-header">Edité un produit</h5>
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group {{(($product->child_cat_id)? '' : 'd-none')}}" id="child_cat_div">
          ...
          <select name="child_cat_id" id="child_cat_id" class="form-control">
              <option value="">--Selectionner une sous cathegorie--</option>
        ...
        <div class="form-group">
          <label for="discount" class="col-form-label">Rabais(%)</label>
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              @foreach($items as $item)              
                ...
                // dd($data);
                @endphp
              <option value="S"  @if( in_array( "S",$data ) ) selected @endif>petite</option>
              <option value="M"  @if( in_array( "M",$data ) ) selected @endif>Moyenne</option>
              <option value="L"  @if( in_array( "L",$data ) ) selected @endif>Grande</option>
              <option value="XL"  @if( in_array( "XL",$data ) ) selected @endif>Très grande</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="default" {{(($product->condition=='default')? 'selected':'')}}>Defaut</option>
